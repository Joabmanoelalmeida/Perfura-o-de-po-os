...
for i in range(1, 4):
    ...
    if di is not None and di != 0:  
        ...
        velocidade1_4[i] = resultado
    else:
        velocidade1_4[i] = "Di1 não disponível ou igual a zero."

for trecho, velocidade in velocidade1_4.items():
...
for i in range(1, 10):
    ...
    if i in velocidade1_4:
        velocidade_media = velocidade1_4[i]
...
#Vazões
Q_cascalho = 0.7*taxa_penetração_media*Rop**2/314
